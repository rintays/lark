...
**Owner:** AG  
**Where:** `<repo>/BACKLOG.md` (mirror: `<workspace>/BACKLOG.md`)  
**Repo:** `<repo>`  
...
- ✅ **Design doc (living)**: `<workspace>/design/lark-auth-credentials-design.md`
...
- [x] Align help text and examples.
  ...
  - [x] README now points to the correct backlog path (`<repo>/BACKLOG.md`)
